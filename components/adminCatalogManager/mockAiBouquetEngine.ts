...
const BOUQUET_FLOWER_RULES: BouquetFlowerRule[] = [
  ...
  },
  {
    ...
    shortDescription: "Элегантная композиция с орхидеями",
    composition: "Орхидеи, декоративная зелень, премиальная упаковка Bellaflore",
    tags: ["орхидеи", "премиум", "эксклюзив"],
    basePrice: 19900,
  },
  {
...
export function inferBouquetProfile(rawTitle: string): InferredBouquetProfile {
  ...
  return {
    ...
    suggestFeatured: rule.categoryId === "compositions" || rule.basePrice >= 14900,
    suggestNew: /новин|new|cloud/i.test(title),
    suggestBestseller: rule.categoryId === "compositions" || rule.categoryId === "roses",
  };
}
