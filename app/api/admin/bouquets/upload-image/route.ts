// ==================================================
// SECTION: Admin API — Bouquet Image Upload
// РАЗДЕЛ: Admin API — загрузка изображения букета
// ==================================================
import {
...
export async function POST(request: Request) {
  ...
  if (image.size > MAX_IMAGE_BYTES) {
    return Response.json({ message: "Изображение слишком большое. Максимум 20 МБ." }, { status: 413 });
  }
