// ==================================================
// SECTION: Admin API — Promo banner slide image upload / removal
// ==================================================
import {
...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    ...
    const slide = await updatePromoBannerSlide(id, { imageUrl: stored.imageUrl });
    return Response.json({ imageUrl: stored.imageUrl, storage: stored.storage, slide });
  } catch (error) {
...
export async function DELETE(request: Request, context: RouteContext) {
  ...
  try {
    const slide = await updatePromoBannerSlide(id, { imageUrl: "" });
